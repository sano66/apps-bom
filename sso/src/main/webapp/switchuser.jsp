...
<html><head><title>Login Page</title></head><body onload='document.f.branchid.focus();'>
        ...
        <h3>Login with Username and Password</h3><form name='f' action='<c:url value="/login/impersonate"/>' method='POST'>
            <table>
                <tr><td>Branch:</td><td><input type='text' name='branchid' value=''></td></tr>
                <tr><td>User:</td><td><input type='text' name='userid' value=''></td></tr>
                <tr><td colspan='2'><input name="submit" type="submit" value="switch user"/></td></tr>
            </table>
            <sec:csrfInput/>
        </form>
        <hr>        
